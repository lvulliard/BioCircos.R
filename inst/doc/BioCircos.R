...
BioCircos(tracks, chrPad = 0.05, displayGenomeBorder = FALSE, LINEMouseOutDisplay = FALSE, 
  LINEMouseOverTooltipsHtml01 = "Pretty lines")
...
tracks = tracks + BioCircosLinkTrack("testLink2", gene1Chromosomes = chr3, 
  gene1Starts = linkPos3, gene1Ends = linkPos3+5000000, gene2Chromosomes = chr4, color = "#FF6666", 
  axisPadding = 6, labels = paste(chr3, chr4, sep = "-"), displayLabel = F,
